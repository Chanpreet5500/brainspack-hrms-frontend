...
const Sign = () => {
    return (
        <div className="w-full h-[100vh] border border-black flex  bg-center bg-no-repeat bg-cover bg-[#837f9dcc]"
        >
            ...
            <div className="rounded-tl-[550px] rounded-bl-[350px]  w-[55%] h-[100%] bg-[#00000085] flex items-center justify-between h-full">
                <div className=" h-[60%] w-full items-center justify-center flex">
                    <div className=" flex gap-2 p-2 border border-gray-300 rounded-full text-white hover:bg-[#00000030] hover:cursor">
