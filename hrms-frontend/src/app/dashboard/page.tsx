...
import { IconArrowUpRight, IconChevronDown, IconCircleArrowRight, IconPlus } from "@tabler/icons-react";
        ...
        <div className="flex flex-col gap-8 max-sm:gap-6">
            <div className="flex w-full justify-between flex-wrap sm:gap-5 md:gap-5 lg:gap-0 max-sm:gap-6">
                                        ...
                                        <div className="flex w-full">
                                            <div className="flex flex-col w-full text-black">
                                                ...
                                                <div className="text-lg w-full flex justify-between">
                                                    ...
                                                    <span className="text-black"><IconCircleArrowRight size={30} stroke={1} /></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="flex flex-col lg:w-[30%] md:w-[48%] w-full">
                    <span className="text-2xl font-medium lg:h-[75px]  md:h-[50px] max-sm:h-[45px]">Time Sheet</span>
                    <div className=" bg-white h-auto items-center flex flex-col rounded-xl py-4">
                        ...
                        <div className="w-[90%] flex flex-col items-center  justify-center gap-4">
                            ...
                            <div className="flex justify-between w-full md:h-[34px] max-sm:h-[40px] lg:h-[34px]  items-start">
                                ...
                                <div><IconChevronDown stroke={1.5} /></div>
                            </div>
                ...
                <div className="flex flex-col lg:w-[27%] md:w-[49%] w-full">
                    <span className="text-2xl font-medium lg:h-[75px]  md:h-[50px] max-sm:h-[45px]">Latest Member</span>
                    <div className=" bg-white h-auto rounded-xl">
                        <div className="w-full flex flex-col justify-center items-center">
                            {memberData.map((value, index) => {
                                return (
                                    <div className="flex w-full lg:h-[88px]  max-lg:h-[8.7vh] max-md:h-[88px] h-[12vh] max-sm:h-[88px] sm:h-[91px] items-center justify-center gap-2 border-b-[1px] border-#dedede last:border-none" key={index}>
                                        <div className="w-[90%] flex gap-2 items-center">
                                            <div className="h-[60px] w-[60px] bg-[green] rounded-full overflow-hidden">
                                                <img src="https://pbs.twimg.com/media/FjU2lkcWYAgNG6d.jpg" alt="demo" className="object-cover w-full h-full" />
                                            </div>
                            ...
                            <div className="flex flex-wrap gap-5">
                                {
                                    attendancedata.map((ele) => {
                                        return (
                                            <div className="border border-black-500 rounded-3xl w-[45%] h-[130px] bg-green-300 flex grow items-center justify-center "
                                                key={ele.id}
                        ...
                        <div className="flex flex-col w-[92%] justify-between gap-3">
                            <div className="flex gap-2 items-center ">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-neutral-500">Type : Sick and casual leave</div>
                                </div>
                            </div>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="w-[74%] lg:min-h-[108px] md:h-[100px] max-sm:h-[80px] rounded-3xl bg-gray-200 flex justify-center items-center">
                                                        <div className="w-[90%] min-h-[70%]">
                                                            ...
                                                            <p className="text-sm">I want to take a day off on 17nov</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </>
