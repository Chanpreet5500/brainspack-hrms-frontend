    ...
    <div className="flex flex-col  gap-8 max-sm:gap-6 p-4">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-between items-end h-[50px]">
          ...
          <span className="text-xl font-medium hidden sm:hidden md:hidden lg:block">
            Latest Member
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-between items-start w-full md:gap-6 h-full lg:gap-0 max-sm:gap-6"></div>
    </div>
  );
};
